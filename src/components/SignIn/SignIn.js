...
const SignIn = () => {
  ...
  function LogIn() {
    window.location = `https://accounts.google.com/o/oauth2/v2/auth?scope=openid%20profile%20email&include_granted_scopes=true&response_type=token&state=state_parameter_passthrough_value&redirect_uri=http%3A//localhost:3000&client_id=926266180989-69mt47ld4fps0lgpm4unl8f94jrgk1gs.apps.googleusercontent.com`
